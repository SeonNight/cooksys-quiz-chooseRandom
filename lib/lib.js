...
const chooseRandom = exports.chooseRandom = (array, numItems) => {
    ...
    numItems === undefined || numItems < 1 || numItems > array.length ? Math.floor(Math.random() * array.length) + 1 //If given number is invalid return a number between 1 and array length
